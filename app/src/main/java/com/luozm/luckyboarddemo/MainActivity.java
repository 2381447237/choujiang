...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Bitmap ake = BitmapFactory.decodeResource(getResources(), R.drawable.ake);
        Bitmap bailishouyue = BitmapFactory.decodeResource(getResources(), R.drawable.bailishouyue);
        Bitmap caocao = BitmapFactory.decodeResource(getResources(), R.drawable.caocao);
        Bitmap huangzhong = BitmapFactory.decodeResource(getResources(), R.drawable.huangzhong);
        Bitmap liubei = BitmapFactory.decodeResource(getResources(), R.drawable.liubei);
        Bitmap xiahoudun = BitmapFactory.decodeResource(getResources(), R.drawable.xiahoudun);
        Bitmap zhangfei = BitmapFactory.decodeResource(getResources(), R.drawable.zhangfei);
        Bitmap zhaoyun = BitmapFactory.decodeResource(getResources(), R.drawable.zhaoyun);
        List<LuckyAward> awards = new ArrayList<>();
        awards.add(new LuckyAward("阿珂", ake, 0.1f));//表示中奖的概率（范围在0到1之间）
